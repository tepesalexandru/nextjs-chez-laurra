  ...
  return (
    <div className="flex flex-col items-center">
      <div className="sImgBox">
        <img className="sImg" src="./assets/images/IMG_0510.jpg" alt="food" />
      </div>
      {/* Name */}
      <a href="./recipe.html" className="cardLink">
        <h3 className="flex-1 truncate">Looks Non-Veg hue hue hehe</h3>
        <svg
